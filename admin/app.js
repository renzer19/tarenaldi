...
const inputTask= document.querySelector('#date');
...
//Creaes li & a-Tag element and adds it to the ul
...
// Deletes a ingle task from the task list
...
// Deleted task from local storage
